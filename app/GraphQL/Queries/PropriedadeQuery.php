...
class PropriedadeQuery extends Query
{
    ...
    {
        return true; // Auth::user()->can('propriedade:view');
    }

    public function type(): Type
    {
        return GraphQL::paginate('Propriedade');
    }

    public function args(): array
    {
        return [
            'filter' => ['name' => 'filter', 'type' => GraphQL::type('PropriedadeFilter')],
            'order' => ['name' => 'order', 'type' => GraphQL::type('PropriedadeOrder')],
