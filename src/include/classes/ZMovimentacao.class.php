...
class ZMovimentacao {
	...
	private static function validarCampos(&$movimentacao) {
		...
		else if(!in_array($movimentacao['aberta'], array('Y', 'N')))
		...
		else if(!is_numeric($movimentacao['funcionariofechamentoid']))
	...
	public static function getTodas($caixa_id = null, $aberta = null, $inicializador_id = null, 
