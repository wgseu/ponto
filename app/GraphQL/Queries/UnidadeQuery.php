...
class UnidadeQuery extends Query
{
    ...
    {
        return Auth::check() && Auth::user()->can('unidade:view');
    }

    public function type(): Type
    {
        return GraphQL::paginate('Unidade');
    }
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Filter::apply(
            $args['filter'] ?? [],
            Unidade::with($fields->getRelations())->select($fields->getSelect())
        );
