...
CREATE TABLE IF NOT EXISTS `Cheques` (
  ...
  CONSTRAINT `FK_Cheques_Clientes_ClienteID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Cheques lançados como pagamentos[N:Cheque|Cheques][G:o][L:Pagamento][K:MZ\\Payment|MZ\\Payment\\][H:SyncModel]';
...
CREATE TABLE IF NOT EXISTS `Produtos_Pedidos` (
  ...
  CONSTRAINT `FK_ProdPed_Pagamentos_PagamentoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Produtos, taxas e serviços do pedido, a alteração do estado permite o controle de produção[N:Item do pedido|Itens do pedido][G:o][L:Pagamento][K:MZ\\Sale|MZ\\Sale\\][H:SyncModel]';
...
CREATE TABLE IF NOT EXISTS `Folhas_Cheques` (
  ...
  CONSTRAINT `FK_Folhas_Cheques_Cheques_ChequeID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Folhas de cheque de um pagamento[N:Folha de cheque|Folhas de cheques][G:a][L:Pagamento][K:MZ\\Payment|MZ\\Payment\\][H:SyncModel]';
...
CREATE TABLE IF NOT EXISTS `Promocoes` (
  ...
  CONSTRAINT `FK_Promocoes_Produtos_ProdutoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa se há descontos nos produtos em determinados dias da semana, o preço pode subir ou descer[N:Promoção|Promoções][G:a][L:CadastroProdutos][K:MZ\\Sale|MZ\\Sale\\][H:SyncModel]';
