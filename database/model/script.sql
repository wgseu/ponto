...
-- Fri 22 Nov 2019 09:41:19 AM -03
...
CREATE TABLE IF NOT EXISTS `carteiras` (
  ...
  `saldo` DECIMAL(19,4) NOT NULL DEFAULT 0 COMMENT 'Saldo pago dessa carteira[G:o][N:Saldo][F:0]',
  `lancado` DECIMAL(19,4) NOT NULL DEFAULT 0 COMMENT 'Total de lançamentos nessa carteira[G:o][N:Lançado][F:0]',
