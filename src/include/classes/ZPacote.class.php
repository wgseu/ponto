...
class ZPacote {
	...
	private static function validarCampos(&$pacote) {
		...
		else if(!is_numeric($pacote['produtoid']))
		...
		else if(!is_numeric($pacote['propriedadeid']))
		...
		else if(!is_numeric($pacote['associacaoid']))
