...
class ZProduto
{
    ...
    private static function validarCampos(&$produto)
    {
        ...
        } elseif (!is_number($produto['codigobarras'])) {
        ...
        } elseif (!is_numeric($produto['setorestoqueid'])) {
        ...
        } elseif (!is_numeric($produto['setorpreparoid'])) {
        ...
        } elseif (!is_numeric($produto['tributacaoid'])) {
        ...
        } elseif ($produto['quantidadelimite'] < 0) {
        ...
        } elseif (!is_numeric($produto['custoproducao'])) {
            $erros['custoproducao'] = 'O custo de produção não foi informado';
        } elseif ($produto['custoproducao'] < 0) {
