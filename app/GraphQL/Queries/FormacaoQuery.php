...
class FormacaoQuery extends Query
{
    ...
    {
        return Auth::check() && Auth::user()->can('formacao:view');
    }

    public function type(): Type
    {
        return GraphQL::paginate('Formacao');
    }
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Filter::apply(
            $args['filter'] ?? [],
            Formacao::with($fields->getRelations())->select($fields->getSelect())
        );
