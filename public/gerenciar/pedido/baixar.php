...
try {
    ...
    $pedidos = Pedido::findAll($condition);
    // Coluna dos dados
    $columns = [
        'Código',
        'Caixa',
        'Destino',
        'Produtos ('. $app->getSystem()->getCurrency()->getSimbolo() . ')',
        'Comissão ('. $app->getSystem()->getCurrency()->getSimbolo() . ')',
        'Serviços ('. $app->getSystem()->getCurrency()->getSimbolo() . ')',
        'Subtotal ('. $app->getSystem()->getCurrency()->getSimbolo() . ')',
        'Descontos ('. $app->getSystem()->getCurrency()->getSimbolo() . ')',
