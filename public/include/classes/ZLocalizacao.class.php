...
class ZLocalizacao
{
    ...
    private static function validarCampos(&$localizacao)
    {
        ...
        } elseif (!check_cep($localizacao['cep'])) {
        ...
        } elseif (!in_array($localizacao['tipo'], array('Casa', 'Apartamento'))) {
        ...
        } elseif (!is_numeric($localizacao['latitude'])) {
        ...
        } elseif (!is_numeric($localizacao['longitude'])) {
        ...
        } elseif (!in_array($localizacao['mostrar'], array('Y', 'N'))) {
