...
INSERT INTO `Produtos` (`ID`, `Codigo`, `CodigoBarras`, `CategoriaID`, `UnidadeID`, `SetorEstoqueID`, `SetorPreparoID`, `TributacaoID`, `Descricao`, `Abreviacao`, `Detalhes`, `QuantidadeLimite`, `QuantidadeMaxima`, `Conteudo`, `PrecoVenda`, `CustoProducao`, `Tipo`, `CobrarServico`, `Divisivel`, `Pesavel`, `Perecivel`, `TempoPreparo`, `Visivel`, `ImagemURL`, `DataAtualizacao`) VALUES
	(1, 1, NULL, 4, 1, 1, 4, NULL, 'Coca Cola 350ml', NULL, NULL, 12, 36, 1, 3.5, NULL, 'Produto', 'Y', 'N', 'N', 'N', 0, 'Y', 'coca-cola_lata_350ml.png', NOW()),
	(2, 2, NULL, 10, 1, 1, 2, NULL, 'X-Burguer', NULL, NULL, 0, 0, 1, 15, NULL, 'Composicao', 'Y', 'N', 'N', 'N', 0, 'Y', 'x-burguer.png', NOW()),
	(3, 3, NULL, 13, 1, 1, 2, NULL, 'Alface', NULL, NULL, 3, 6, 1, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'alface.png', NOW()),
	(4, 4, NULL, 13, 1, 1, 2, NULL, 'Tomate', NULL, NULL, 20, 40, 1, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'tomate.png', NOW()),
	(5, 5, NULL, 1, 1, 1, 2, NULL, 'Pizza', NULL, NULL, 0, 0, 1, 0, NULL, 'Pacote', 'Y', 'N', 'N', 'N', 0, 'Y', 'pizza.png', NOW()),
	(6, 6, NULL, 10, 1, 1, 2, NULL, 'X-Bacon', NULL, NULL, 0, 0, 1, 18, NULL, 'Composicao', 'Y', 'N', 'N', 'N', 0, 'Y', 'x-bacon.png', NOW()),
	(7, 7, NULL, 1, 1, 1, 2, NULL, 'Mussarela', NULL, NULL, 0, 0, 1, 0, NULL, 'Composicao', 'Y', 'Y', 'N', 'N', 0, 'N', 'pizza_mussarela.png', NOW()),
	(8, 8, NULL, 1, 1, 1, 2, NULL, 'Calabresa', NULL, NULL, 0, 0, 1, 0, NULL, 'Composicao', 'Y', 'Y', 'N', 'N', 0, 'N', 'pizza_calabresa.png', NOW()),
	(9, 9, NULL, 1, 3, 1, 2, NULL, 'Catupiry 1kg', NULL, NULL, 2, 6, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'catupiry.png', NOW()),
	(10, 10, NULL, 1, 3, 1, 2, NULL, 'Cheddar 1kg', NULL, NULL, 2, 6, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'cheddar.png', NOW()),
	(11, 11, NULL, 1, 1, 1, 2, NULL, 'Pão', NULL, NULL, 30, 90, 1, 0, NULL, 'Produto', 'Y', 'N', 'N', 'N', 0, 'N', 'pao.png', NOW()),
	(12, 12, NULL, 1, 1, 1, 2, NULL, 'Ovo', NULL, NULL, 15, 90, 1, 0, NULL, 'Produto', 'Y', 'N', 'N', 'N', 0, 'N', 'ovo.png', NOW()),
	(13, 13, NULL, 1, 1, 1, 2, NULL, 'Cebola', NULL, NULL, 20, 40, 1, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'cebola.png', NOW()),
	(14, 14, NULL, 1, 3, 1, 2, NULL, 'Bacon 1kg', 'Bacon', NULL, 3, 6, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'bacon.png', NOW()),
	(15, 15, NULL, 1, 1, 1, 2, NULL, 'Hamburguer artesanal', 'Hamburguer', NULL, 0, 0, 1, 0, NULL, 'Composicao', 'Y', 'N', 'N', 'N', 0, 'N', 'hamburguer_artesanal.png', NOW()),
	(16, 16, NULL, 14, 1, 1, 2, NULL, 'Açaí', NULL, NULL, 0, 0, 1, 8, NULL, 'Composicao', 'Y', 'N', 'N', 'N', 0, 'Y', 'acai.png', NOW()),
	(17, 17, NULL, 14, 3, 1, 2, NULL, 'Morango 1kg', 'Morango', NULL, 1, 2, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'morango.png', NOW()),
	(18, 18, NULL, 14, 3, 1, 2, NULL, 'Chocolate 1kg', 'Chocolate', NULL, 1, 3, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'chocolate.png', NOW()),
	(19, 19, NULL, 14, 3, 1, NULL, NULL, 'Leite condensado 1kg', 'Leite condensado', NULL, 0.35, 1.75, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'leite_condensado.png', NOW()),
	(20, 20, NULL, 14, 3, 1, NULL, NULL, 'Polpa de açai 1kg', 'Açaí', NULL, 2, 5, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'Y', 0, 'N', 'polpa_de_acai.png', NOW()),
	(21, 21, NULL, 1, 3, 1, NULL, NULL, 'Massa de pizza', NULL, NULL, 2, 5, 1000, 0, NULL, 'Composicao', 'Y', 'Y', 'N', 'N', 0, 'N', 'massa_de_pizza.png', NOW()),
	(22, 22, NULL, 15, 2, 1, NULL, NULL, 'Óleo de soja 1L', NULL, NULL, 1.8, 7.2, 1, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'oleo_de_soja.png', NOW()),
	(23, 23, NULL, 16, 3, 1, NULL, NULL, 'Orégano 1kg', 'Orégano', NULL, 0.4, 1, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'oregano.png', NOW()),
	(24, 24, NULL, 1, 3, 1, 2, NULL, 'Farinha de trigo 1kg', 'Farinha de trigo', NULL, 10, 20, 1000, 0, NULL, 'Produto', 'Y', 'Y', 'N', 'N', 0, 'N', 'farinha_de_trigo.png', NOW()),
	(25, 25, NULL, 1, 1, 1, 2, NULL, 'Borda de Catupiry', 'Catupiry', NULL, 60, 120, 1, 0, NULL, 'Composicao', 'Y', 'N', 'N', 'N', 0, 'N', 'borda_de_catupiry.png', NOW()),
	(26, 26, NULL, 1, 1, 1, 2, NULL, 'Borda de Cheddar', 'Cheddar', NULL, 60, 120, 1, 0, NULL, 'Composicao', 'Y', 'N', 'N', 'N', 0, 'N', 'borda_de_cheddar.png', NOW());
