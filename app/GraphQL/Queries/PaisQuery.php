...
class PaisQuery extends Query
{
    ...
    {
        return true; // Auth::user()->can('pais:view');
    }

    public function type(): Type
    {
        return GraphQL::paginate('Pais');
    }

    public function args(): array
    {
        return [
            'filter' => ['name' => 'filter', 'type' => GraphQL::type('PaisFilter')],
            'order' => ['name' => 'order', 'type' => GraphQL::type('PaisOrder')],
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Pais::with($fields->getRelations())
