...
-- 06/30/17 20:50:07
-- Model: GrandChef Model    Version: 1.9.3.0
...
CREATE TABLE IF NOT EXISTS `Catalogos` (
  ...
  CONSTRAINT `FK_Catalogos_Fornecedores_FornecedorID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa a lista de produtos disponíveis nos fornecedores[N:Catálogo de produtos|Catálogos de produtos][G:o][L:CadastroFornecedores][K:MZ\\Stock|MZ\\Stock\\][H:\\MZ\\Database\\Helper]';
...
CREATE TABLE IF NOT EXISTS `Listas` (
  ...
  `EncarregadoID` INT NOT NULL COMMENT 'Informa o funcionário encarregado de fazer as compras[N:Encarregado][G:o]',
...
CREATE TABLE IF NOT EXISTS `Compras` (
  ...
  `CompradorID` INT NOT NULL COMMENT 'Informa o funcionário que comprou os produtos da lista[N:Comprador][G:o]',
  `FornecedorID` INT NOT NULL COMMENT 'Fornecedor em que os produtos foram compras[N:Fornecedor][G:o]',
  `DocumentoURL` VARCHAR(150) NULL DEFAULT NULL COMMENT 'Informe o nome do documento na URL[N:Documento][G:o]',
  ...
  CONSTRAINT `FK_Compras_Funcionarios_CompradorID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Compras realizadas em uma lista num determinado fornecedor[N:Compra|Compras][G:a][L:ListaCompras][K:MZ\\Stock|MZ\\Stock\\][H:\\MZ\\Database\\Helper]';
...
CREATE TABLE IF NOT EXISTS `Requisitos` (
  ...
  `ListaID` INT NOT NULL COMMENT 'Lista de compra desse produto[N:Lista de compra][G:a]',
  `ProdutoID` INT NOT NULL COMMENT 'Produto que deve ser comprado[N:Produto][G:o][S]',
  `CompraID` INT NULL DEFAULT NULL COMMENT 'Informa em qual fornecedor foi realizado a compra desse produto[G:a][N:Compra]',
  ...
  `Comprado` DOUBLE NOT NULL DEFAULT 0 COMMENT 'Informa se esse produto já foi comprado[N:Comprado][G:o]',
  ...
  `DataRecolhimento` DATETIME NOT NULL COMMENT 'Informa do recolhimento da mercadoria na pratileira[N:Data de recolhimento][G:a]',
  PRIMARY KEY (`ID`),
