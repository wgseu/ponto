...
-- Wed 11 Dec 2019 04:20:58 PM -03
...
CREATE TABLE IF NOT EXISTS `integracoes` (
  ...
  `codigo` VARCHAR(45) NOT NULL COMMENT 'Identicador da integração nome unix_case[G:o][N:Codigo]',
  `descricao` VARCHAR(200) NULL DEFAULT NULL COMMENT 'Descrição do módulo integrador[G:a][N:Descrição]',
  `tipo` ENUM('pedido', 'login', 'dispositivo', 'pagamento', 'outros') NOT NULL COMMENT 'Tipo de integração se pedido, login, dispositivo, pagamento, outros[G:o][N:Tipo][F:self::TIPO_PEDIDO]',
