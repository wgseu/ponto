...
class ModuloQuery extends Query
{
    ...
    {
        return Auth::check() && Auth::user()->can('modulo:view');
    }

    public function type(): Type
    {
        return GraphQL::paginate('Modulo');
    }
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Filter::apply(
            $args['filter'] ?? [],
            Modulo::with($fields->getRelations())->select($fields->getSelect())
        );
