...
class ZServico {
	...
	private static function validarCampos(&$servico) {
		...
		else if(!in_array($servico['obrigatorio'], array('Y', 'N')))
		...
		if(!is_numeric($servico['valor']))
			...
			else if(is_equal($servico['valor'], 0))
