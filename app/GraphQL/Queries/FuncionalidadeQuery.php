...
class FuncionalidadeQuery extends Query
{
    ...
    {
        return true; // Auth::user()->can('funcionalidade:view');
    }
    ...
    {
        return [
            'filter' => ['name' => 'filter', 'type' => GraphQL::type('FuncionalidadeFilter')],
            'order' => ['name' => 'order', 'type' => GraphQL::type('FuncionalidadeOrder')],
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Funcionalidade::with($fields->getRelations())
