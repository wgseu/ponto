...
class ComandaQuery extends Query
{
    ...
    {
        return Auth::check() && Auth::user()->can('comanda:view');
    }

    public function type(): Type
    {
        return GraphQL::paginate('Comanda');
    }
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Filter::apply(
            $args['filter'] ?? [],
            Comanda::with($fields->getRelations())->select($fields->getSelect())
        );
