...
ENGINE = InnoDB
COMMENT = 'Mesas para lançamento de pedidos[N:Mesa|Mesas][G:a][L:Cadas' /* comment truncated */ /*troMesas][K:MZ\Environment|MZ\Environment\][H:Model]*/;
...
ENGINE = InnoDB
COMMENT = 'Sessão de trabalho do dia, permite que vários caixas sejam' /* comment truncated */ /* abertos utilizando uma mesma sessão[N:Sessão|Sessões][G:a][L:AbrirCaixa][K:MZ\Session|MZ\Session\][H:Model]*/;
...
ENGINE = InnoDB
COMMENT = 'Caixas de movimentação financeira[N:Caixa|Caixas][G:o][L:C' /* comment truncated */ /*adastroCaixas][K:MZ\Session|MZ\Session\][H:Model]*/;
...
ENGINE = InnoDB
COMMENT = 'Bancos disponíveis no país[N:Banco|Bancos][G:o][L:Cadastro' /* comment truncated */ /*Bancos][K:MZ\Wallet|MZ\Wallet\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Carteiras` (
  ...
  CONSTRAINT `FK_Carteiras_Bancos_BancoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa uma conta bancária ou uma carteira financeira[N:Car' /* comment truncated */ /*teira|Carteiras][G:a][L:CadastroCarteiras][K:MZ\Wallet|MZ\Wallet\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Formas_Pagto` (
  ...
  CONSTRAINT `FK_Formas_Pagto_Carteiras_CarteiraPagtoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Formas de pagamento disponíveis para pedido e contas[N:Form' /* comment truncated */ /*a de pagamento|Formas de pagamento][G:a][L:CadastroFormasPagto][K:MZ\Payment|MZ\Payment\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Cartoes` (
  ...
  CONSTRAINT `FK_Cartoes_Carteiras_CarteiraPagtoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Cartões utilizados na forma de pagamento em cartão[N:Ca' /* comment truncated */ /*rtão|Cartões][G:o][L:CadastroCartoes][K:MZ\Payment|MZ\Payment\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Funcoes` (
  ...
  UNIQUE INDEX `Descricao_UNIQUE` (`Descricao` ASC))
ENGINE = InnoDB
COMMENT = 'Função ou cargo de um funcionário[N:Função|Funções][G' /* comment truncated */ /*:a][L:AlterarConfiguracoes][K:MZ\Employee|MZ\Employee\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Clientes` (
  ...
  CONSTRAINT `FK_Clientes_Clientes_AcionistaID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações de cliente físico ou jurídico. Clientes, emp' /* comment truncated */ /*resas, funcionários, fornecedores e parceiros são cadastrados aqui[N:Cliente|Clientes][G:o][L:CadastroClientes][K:MZ\Account|MZ\Account\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Funcionarios` (
  ...
  CONSTRAINT `FK_Funcionarios_Clientes_ClienteID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Funcionário que trabalha na empresa e possui uma determinad' /* comment truncated */ /*a função[N:Funcionário|Funcionários][G:o][L:CadastroFuncionarios][K:MZ\Employee|MZ\Employee\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Moedas` (
  ...
  PRIMARY KEY (`ID`))
ENGINE = InnoDB
COMMENT = 'Moedas financeiras de um país[N:Moeda|Moedas][G:a][L:Cadast' /* comment truncated */ /*roMoedas][K:MZ\Wallet|MZ\Wallet\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Paises` (
  ...
  CONSTRAINT `FK_Paises_Moedas_MoedaID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações de um páis com sua moeda e língua nativa[N:P' /* comment truncated */ /*aís|Paises][G:o][L:CadastroPaises][K:MZ\Location|MZ\Location\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Estados` (
  ...
  CONSTRAINT `FK_Estados_Paises_PaisID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Estado federativo de um país[N:Estado|Estados][G:o][L:Cadas' /* comment truncated */ /*troEstados][K:MZ\Location|MZ\Location\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Cidades` (
  ...
  CONSTRAINT `FK_Cidades_Estados_EstadoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Cidade de um estado, contém bairros[N:Cidade|Cidades][G:a][' /* comment truncated */ /*L:CadastroCidades][K:MZ\Location|MZ\Location\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Bairros` (
  ...
  CONSTRAINT `FK_Bairros_Cidades_CidadeID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Bairro de uma cidade[N:Bairro|Bairros][G:o][L:CadastroBairro' /* comment truncated */ /*s][K:MZ\Location|MZ\Location\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Localizacoes` (
  ...
  CONSTRAINT `FK_Localizacoes_Bairros`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Endereço detalhado de um cliente[N:Localização|Localizaç' /* comment truncated */ /*ões][G:a][L:CadastroClientes][K:MZ\Location|MZ\Location\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Comandas` (
  ...
  UNIQUE INDEX `Nome_UNIQUE` (`Nome` ASC))
ENGINE = InnoDB
COMMENT = 'Comanda individual, permite lançar pedidos em cartões de c' /* comment truncated */ /*onsumo[N:Comanda|Comandas][G:a][L:CadastroComandas][K:MZ\Sale|MZ\Sale\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Movimentacoes` (
  ...
  CONSTRAINT `FK_Movimentacoes_Funcionarios_FuncionarioFechamentoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Movimentação do caixa, permite abrir diversos caixas na co' /* comment truncated */ /*nta de operadores[N:Movimentação|Movimentações][G:a][L:AbrirCaixa][K:MZ\Session|MZ\Session\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Pedidos` (
  ...
  CONSTRAINT `FK_Pedidos_Funcionarios_FechadorID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações do pedido de venda[N:Pedido|Pedidos][G:o][L:Pa' /* comment truncated */ /*gamento][K:MZ\Sale|MZ\Sale\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Categorias` (
  ...
  CONSTRAINT `FK_Categorias_Categorias_CategoriaID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa qual a categoria dos produtos e permite a rápida lo' /* comment truncated */ /*calização dos mesmos[N:Categoria|Categorias][G:a][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Unidades` (
  ...
  UNIQUE INDEX `Sigla_UNIQUE` (`Sigla` ASC))
ENGINE = InnoDB
COMMENT = 'Unidades de medidas aplicadas aos produtos[N:Unidade|Unidade' /* comment truncated */ /*s][G:a][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Setores` (
  ...
  UNIQUE INDEX `Nome_UNIQUE` (`Nome` ASC))
ENGINE = InnoDB
COMMENT = 'Setor de impressão e de estoque[N:Setor|Setores][G:o][L:Est' /* comment truncated */ /*oque][K:MZ\Environment|MZ\Environment\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Origens` (
  ...
  UNIQUE INDEX `Codigo_UNIQUE` (`Codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Origem da mercadoria[N:Origem|Origens][G:a][L:CadastroProdut' /* comment truncated */ /*os][K:MZ\Invoice|MZ\Invoice\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Operacoes` (
  ...
  UNIQUE INDEX `Codigo_UNIQUE` (`Codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Código Fiscal de Operações e Prestações (CFOP)[N:' /* comment truncated */ /*Operação|Operações][G:a][L:CadastroProdutos][K:MZ\Invoice|MZ\Invoice\][H:Model]*/;
...
ENGINE = InnoDB
COMMENT = 'Impostos disponíveis para informar no produto[N:Imposto|Imp' /* comment truncated */ /*ostos][G:o][L:CadastroProdutos][K:MZ\Invoice|MZ\Invoice\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Tributacoes` (
  ...
  CONSTRAINT `FK_Tributacoes_Impostos_ImpostoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informação tributária dos produtos[N:Tributação|Tributa' /* comment truncated */ /*ções][G:a][L:CadastroProdutos][K:MZ\Invoice|MZ\Invoice\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Produtos` (
  ...
  CONSTRAINT `FK_Produtos_Tributacoes_TributacaoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações sobre o produto, composição ou pacote[N:Prod' /* comment truncated */ /*uto|Produtos][G:o][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Servicos` (
  ...
  PRIMARY KEY (`ID`))
ENGINE = InnoDB
COMMENT = 'Taxas, eventos e serviço cobrado nos pedidos[N:Serviço|Ser' /* comment truncated */ /*viços][G:o][L:CadastroServicos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Produtos_Pedidos` (
  ...
  CONSTRAINT `FK_ProdPed_Servicos_ServicoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Produtos, taxas e serviços do pedido, a alteração do esta' /* comment truncated */ /*do permite o controle de produção[N:Item do pedido|Itens do pedido][G:o][L:Pagamento][K:MZ\Sale|MZ\Sale\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Cheques` (
  ...
  CONSTRAINT `FK_Cheques_Clientes_ClienteID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Cheques lançados como pagamentos[N:Cheque|Cheques][G:o][L:P' /* comment truncated */ /*agamento][K:MZ\Payment|MZ\Payment\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Classificacoes` (
  ...
  CONSTRAINT `FK_Classificacoes_ClassificacaoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Classificação se contas, permite atribuir um grupo de cont' /* comment truncated */ /*as[N:Classificação|Classificações][G:a][L:CadastroContas][K:MZ\Account|MZ\Account\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Contas` (
  ...
  CONSTRAINT `FK_Contas_Classificacoes_SubClassificacaoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Contas a pagar e ou receber[N:Conta|Contas][G:a][L:CadastroC' /* comment truncated */ /*ontas][K:MZ\Account|MZ\Account\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Creditos` (
  ...
  CONSTRAINT `FK_Creditos_Funcionarios_FuncionarioID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Créditos de clientes[N:Crédito|Créditos][G:o][L:Cadastrar' /* comment truncated */ /*Creditos][K:MZ\Account|MZ\Account\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Pagamentos` (
  ...
  CONSTRAINT `FK_Pagamentos_Creditos_CreditoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Pagamentos de contas e pedidos[N:Pagamento|Pagamentos][G:o][' /* comment truncated */ /*L:Pagamento][K:MZ\Payment|MZ\Payment\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Auditoria` (
  ...
  CONSTRAINT `FK_Auditoria_Funcionarios_AutorizadorID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Registra todas as atividades importantes do sistema[N:Audito' /* comment truncated */ /*ria|Auditorias][G:a][L:RelatorioAuditoria][K:MZ\System|MZ\System\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Folhas_Cheques` (
  ...
  CONSTRAINT `FK_Folhas_Cheques_Cheques_ChequeID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Folhas de cheque de um pagamento[N:Folha de cheque|Folhas de' /* comment truncated */ /* cheques][G:a][L:Pagamento][K:MZ\Payment|MZ\Payment\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Composicoes` (
  ...
  CONSTRAINT `FK_Composicoes_Produtos_ProdutoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa as propriedades da composição de um produto compos' /* comment truncated */ /*to[N:Composição|Composições][G:a][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Fornecedores` (
  ...
  CONSTRAINT `FK_Fornecedores_Clientes_EmpresaID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Fornecedores de produtos[N:Fornecedor|Fornecedores][G:o][L:C' /* comment truncated */ /*adastroFornecedores][K:MZ\Stock|MZ\Stock\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Estoque` (
  ...
  CONSTRAINT `FK_Estoque_Estoque_EntradaID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Estoque de produtos por setor[N:Estoque|Estoques][G:o][L:Est' /* comment truncated */ /*oque][K:MZ\Stock|MZ\Stock\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Grupos` (
  ...
  CONSTRAINT `FK_Grupos_Produtos_ProdutoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Grupos de pacotes, permite criar grupos como Tamanho, Sabore' /* comment truncated */ /*s para formações de produtos[N:Grupo|Grupos][G:o][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Propriedades` (
  ...
  CONSTRAINT `FK_Propriedades_Grupos_GrupoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa tamanhos de pizzas e opções de peso do produto[N:P' /* comment truncated */ /*ropriedade|Propriedades][G:a][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Pacotes` (
  ...
  CONSTRAINT `FK_Pacotes_Propriedades_PropriedadeID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Contém todos as opções para a formação do produto final' /* comment truncated */ /*[N:Pacote|Pacotes][G:o][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Dispositivos` (
  ...
  CONSTRAINT `FK_Dispositivos_Caixas_CaixaID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Computadores e tablets com opções de acesso[N:Dispositivo|' /* comment truncated */ /*Dispositivos][G:o][L:CadastroComputadores][K:MZ\Device|MZ\Device\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Impressoras` (
  ...
  CONSTRAINT `FK_Impressoras_Setores_SetorID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Impressora para impressão de serviços e contas[N:Impressor' /* comment truncated */ /*a|Impressoras][G:a][L:CadastroImpressoras][K:MZ\Device|MZ\Device\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Promocoes` (
  ...
  CONSTRAINT `FK_Promocoes_Produtos_ProdutoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa se há descontos nos produtos em determinados dias d' /* comment truncated */ /*a semana, o preço pode subir ou descer[N:Promoção|Promoções][G:a][L:CadastroProdutos][K:MZ\Sale|MZ\Sale\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Funcionalidades` (
  ...
  UNIQUE INDEX `Nome_UNIQUE` (`Nome` ASC))
ENGINE = InnoDB
COMMENT = 'Grupo de funcionalidades do sistema[N:Funcionalidade|Funcion' /* comment truncated */ /*alidades][G:a][L:AlterarConfiguracoes][K:MZ\System|MZ\System\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Permissoes` (
  ...
  CONSTRAINT `FK_Permissoes_Funcionalidades_FuncionalidadeID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa a listagem de todas as funções do sistema [N:Permi' /* comment truncated */ /*ssão|Permissões][G:a][L:AlterarConfiguracoes][K:MZ\System|MZ\System\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Acessos` (
  ...
  CONSTRAINT `FK_Acessos_Permissoes_PermissaoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Permite acesso à uma determinada funcionalidade da lista de' /* comment truncated */ /* permissões[N:Acesso|Acessos][G:o][L:AlterarConfiguracoes][K:MZ\Employee|MZ\Employee\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Catalogos` (
  ...
  CONSTRAINT `FK_Catalogos_Fornecedores_FornecedorID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa a lista de produtos disponíveis nos fornecedores[N:' /* comment truncated */ /*Catálogo de produtos|Catálogos de produtos][G:o][L:CadastroFornecedores][K:MZ\Stock|MZ\Stock\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Sistema` (
  ...
  CONSTRAINT `FK_Sistema_Paises_PaisID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Classe que informa detalhes da empresa, parceiro e opções ' /* comment truncated */ /*do sistema como a versão do banco de dados e a licença de uso[N:Sistema|Sistemas][G:o][L:AlterarConfiguracoes][K:MZ\System|MZ\System\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Informacoes` (
  ...
  CONSTRAINT `FK_Informacoes_Unidades_UnidadeID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Permite cadastrar informações da tabela nutricional[N:Info' /* comment truncated */ /*rmação nutricional|Informações nutricionais][G:a][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Resumos` (
  ...
  CONSTRAINT `FK_Resumos_Cartoes_CartaoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Resumo de fechamento de caixa, informa o valor contado no fe' /* comment truncated */ /*chamento do caixa para cada forma de pagamento[N:Resumo|Resumos][G:o][L:ConferirCaixa][K:MZ\Session|MZ\Session\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Formacoes` (
  ...
  CONSTRAINT `FK_Formacoes_Composicoes_ComposicaoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa qual foi a formação que gerou esse produto, assim ' /* comment truncated */ /*como quais item foram retirados/adicionados da composição[N:Formação|Formações][G:a][L:Pagamento][K:MZ\Sale|MZ\Sale\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Listas` (
  ...
  CONSTRAINT `FK_Listas_Funcionario_EncarregadoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Lista de compras de produtos[N:Lista de compra|Listas de com' /* comment truncated */ /*pras][G:a][L:ListaCompras][K:MZ\Stock|MZ\Stock\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Modulos` (
  ...
  UNIQUE INDEX `Nome_UNIQUE` (`Nome` ASC))
ENGINE = InnoDB
COMMENT = 'Módulos do sistema que podem ser desativados/ativados[N:Mó' /* comment truncated */ /*dulo|Módulos][G:o][L:AlterarConfiguracoes][K:MZ\System|MZ\System\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Compras` (
  ...
  CONSTRAINT `FK_Compras_Funcionarios_CompradorID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Compras realizadas em uma lista num determinado fornecedor[N' /* comment truncated */ /*:Compra|Compras][G:a][L:ListaCompras][K:MZ\Stock|MZ\Stock\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Requisitos` (
  ...
  CONSTRAINT `FK_Requisitos_Compras_CompraID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa os produtos da lista de compras[N:Produtos da lista|' /* comment truncated */ /*Produtos das listas][G:o][L:ListaCompras][K:MZ\Stock|MZ\Stock\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Enderecos` (
  ...
  CONSTRAINT `FK_Enderecos_Bairros_BairroID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Endereços de ruas e avenidas com informação de CEP[N:Ende' /* comment truncated */ /*reço|Endereços][G:o][L:CadastroBairros][K:MZ\Location|MZ\Location\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Horarios` (
  ...
  PRIMARY KEY (`ID`))
ENGINE = InnoDB
COMMENT = 'Informa o horário de funcionamento do estabelecimento[N:Hor' /* comment truncated */ /*ário|Horários][G:o][L:AlterarHorario][K:MZ\Company|MZ\Company\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Valores_Nutricionais` (
  ...
  CONSTRAINT `FK_Valores_Nutricionais_Unidades_UnidadeID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa todos os valores nutricionais da tabela nutricional[' /* comment truncated */ /*N:Valor nutricional|Valores nutricionais][G:o][L:CadastroProdutos][K:MZ\Product|MZ\Product\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Transferencias` (
  ...
  CONSTRAINT `FK_Transf_ProdPed_ProdutoPedidoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa a transferência de uma mesa / comanda para outra, o' /* comment truncated */ /*u de um produto para outra mesa / comanda[N:Transferência|Transferências][G:a][L:TransferirProdutos][K:MZ\Sale|MZ\Sale\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Patrimonios` (
  ...
  CONSTRAINT `FK_Patrimonios_Clientes_EmpresaID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa detalhadamente um bem da empresa[N:Patrimônio|Patri' /* comment truncated */ /*mônios][G:o][L:CadastroPatrimonio][K:MZ\Environment|MZ\Environment\][H:Model]*/;
...
ENGINE = InnoDB
COMMENT = 'Página WEB que contém informações de contato, termos e o' /* comment truncated */ /*utras informações da empresa[N:Página|Páginas][G:a][L:AlterarPaginas][K:MZ\System|MZ\System\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Juncoes` (
  ...
  CONSTRAINT `FK_Juncoes_Pedidos_PedidoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Junções de mesas, informa quais mesas estão juntas ao ped' /* comment truncated */ /*ido[N:Junção|Junções][G:a][L:MudarDeMesa][K:MZ\Sale|MZ\Sale\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Regimes` (
  ...
  UNIQUE INDEX `Codigo_UNIQUE` (`Codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Regimes tributários[N:Regime|Regimes][G:o][L:AlterarConfigu' /* comment truncated */ /*racoes][K:MZ\Invoice|MZ\Invoice\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Emitentes` (
  ...
  CONSTRAINT `FK_Emitentes_Regimes_RegimeID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Dados do emitente das notas fiscais[N:Emitente|Emitentes][G:' /* comment truncated */ /*o][L:AlterarConfiguracoes][K:MZ\Invoice|MZ\Invoice\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Notas` (
  ...
  CONSTRAINT `FK_Notas_Pedidos_PedidoID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Notas fiscais e inutilizações[N:Nota|Notas][G:a][L:Relator' /* comment truncated */ /*ioPedidos][K:MZ\Invoice|MZ\Invoice\][H:Model]*/;
...
CREATE TABLE IF NOT EXISTS `Eventos` (
  ...
  CONSTRAINT `FK_Eventos_Notas_NotaID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Eventos de envio das notas[N:Evento|Eventos][G:o][L:Relatori' /* comment truncated */ /*oAuditoria][K:MZ\Invoice|MZ\Invoice\][H:Model]*/;
...
ENGINE = InnoDB
COMMENT = 'Informa quais integrações estão disponíveis[N:Inte' /* comment truncated */ /*gração|Integrações][G:a][L:AlterarConfiguracoes][K:MZ\System|MZ\System\][H:Model]*/;
