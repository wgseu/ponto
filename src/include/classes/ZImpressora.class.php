...
class ZImpressora
{
    ...
    private static function validarCampos(&$impressora)
    {
        ...
        } elseif (!is_numeric($impressora['dispositivoid'])) {
        ...
        } elseif (!in_array($impressora['descricao'], array(null))) {
        ...
        } elseif (!in_array($impressora['modo'], array('Terminal', 'Caixa', 'Servico', 'Estoque'))) {
