...
class FormaQuery extends Query
{
    ...
    {
        return true; // Auth::user()->can('forma:view');
    }
    ...
    {
        return [
            'filter' => ['name' => 'filter', 'type' => GraphQL::type('FormaFilter')],
            'order' => ['name' => 'order', 'type' => GraphQL::type('FormaOrder')],
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Forma::with($fields->getRelations())
