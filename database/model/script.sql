...
CREATE TABLE IF NOT EXISTS `Setores` (
  ...
  CONSTRAINT `FK_Setores_SetorID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Setor de impressão e de estoque[N:Setor|Setores][G:o][L:Estoque][K:MZ\\Environment|MZ\\Environment\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Mesas` (
  ...
  CONSTRAINT `FK_Mesas_Setores_SetorID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Mesas para lançamento de pedidos[N:Mesa|Mesas][G:a][L:CadastroMesas][K:MZ\\Environment|MZ\\Environment\\][H:Model]';
...
ENGINE = InnoDB
COMMENT = 'Sessão de trabalho do dia, permite que vários caixas sejam abertos utilizando uma mesma sessão[N:Sessão|Sessões][G:a][L:AbrirCaixa][K:MZ\\Session|MZ\\Session\\][H:Model]';
...
ENGINE = InnoDB
COMMENT = 'Caixas de movimentação financeira[N:Caixa|Caixas][G:o][L:CadastroCaixas][K:MZ\\Session|MZ\\Session\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Bancos` (
  ...
  UNIQUE INDEX `Numero_UNIQUE` (`Numero` ASC))
ENGINE = InnoDB
COMMENT = 'Bancos disponíveis no país[N:Banco|Bancos][G:o][L:CadastroBancos][K:MZ\\Wallet|MZ\\Wallet\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Carteiras` (
  ...
  CONSTRAINT `FK_Carteiras_Bancos_BancoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa uma conta bancária ou uma carteira financeira[N:Carteira|Carteiras][G:a][L:CadastroCarteiras][K:MZ\\Wallet|MZ\\Wallet\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Formas_Pagto` (
  ...
  CONSTRAINT `FK_Formas_Pagto_Carteiras_CarteiraPagtoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Formas de pagamento disponíveis para pedido e contas[N:Forma de pagamento|Formas de pagamento][G:a][L:CadastroFormasPagto][K:MZ\\Payment|MZ\\Payment\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Cartoes` (
  ...
  CONSTRAINT `FK_Cartoes_Carteiras_CarteiraPagtoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Cartões utilizados na forma de pagamento em cartão[N:Cartão|Cartões][G:o][L:CadastroCartoes][K:MZ\\Payment|MZ\\Payment\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Funcoes` (
  ...
  UNIQUE INDEX `Descricao_UNIQUE` (`Descricao` ASC))
ENGINE = InnoDB
COMMENT = 'Função ou cargo de um funcionário[N:Função|Funções][G:a][L:AlterarConfiguracoes][K:MZ\\Employee|MZ\\Employee\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Clientes` (
  ...
  CONSTRAINT `FK_Clientes_Clientes_AcionistaID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informações de cliente físico ou jurídico. Clientes, empresas, funcionários, fornecedores e parceiros são cadastrados aqui[N:Cliente|Clientes][G:o][L:CadastroClientes][K:MZ\\Account|MZ\\Account\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Funcionarios` (
  ...
  CONSTRAINT `FK_Funcionarios_Clientes_ClienteID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Funcionário que trabalha na empresa e possui uma determinada função[N:Funcionário|Funcionários][G:o][L:CadastroFuncionarios][K:MZ\\Employee|MZ\\Employee\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Moedas` (
  ...
  PRIMARY KEY (`ID`))
ENGINE = InnoDB
COMMENT = 'Moedas financeiras de um país[N:Moeda|Moedas][G:a][L:CadastroMoedas][K:MZ\\Wallet|MZ\\Wallet\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Paises` (
  ...
  CONSTRAINT `FK_Paises_Moedas_MoedaID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informações de um páis com sua moeda e língua nativa[N:País|Paises][G:o][L:CadastroPaises][K:MZ\\Location|MZ\\Location\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Estados` (
  ...
  CONSTRAINT `FK_Estados_Paises_PaisID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Estado federativo de um país[N:Estado|Estados][G:o][L:CadastroEstados][K:MZ\\Location|MZ\\Location\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Cidades` (
  ...
  CONSTRAINT `FK_Cidades_Estados_EstadoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Cidade de um estado, contém bairros[N:Cidade|Cidades][G:a][L:CadastroCidades][K:MZ\\Location|MZ\\Location\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Bairros` (
  ...
  CONSTRAINT `FK_Bairros_Cidades_CidadeID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Bairro de uma cidade[N:Bairro|Bairros][G:o][L:CadastroBairros][K:MZ\\Location|MZ\\Location\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Localizacoes` (
  ...
  CONSTRAINT `FK_Localizacoes_Bairros`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Endereço detalhado de um cliente[N:Localização|Localizações][G:a][L:CadastroClientes][K:MZ\\Location|MZ\\Location\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Comandas` (
  ...
  UNIQUE INDEX `Numero_UNIQUE` (`Numero` ASC))
ENGINE = InnoDB
COMMENT = 'Comanda individual, permite lançar pedidos em cartões de consumo[N:Comanda|Comandas][G:a][L:CadastroComandas][K:MZ\\Sale|MZ\\Sale\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Movimentacoes` (
  ...
  CONSTRAINT `FK_Movimentacoes_Funcionarios_FuncionarioFechamentoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Movimentação do caixa, permite abrir diversos caixas na conta de operadores[N:Movimentação|Movimentações][G:a][L:AbrirCaixa][K:MZ\\Session|MZ\\Session\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Pedidos` (
  ...
  CONSTRAINT `FK_Pedidos_Funcionarios_FechadorID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informações do pedido de venda[N:Pedido|Pedidos][G:o][L:Pagamento][K:MZ\\Sale|MZ\\Sale\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Categorias` (
  ...
  CONSTRAINT `FK_Categorias_Categorias_CategoriaID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa qual a categoria dos produtos e permite a rápida localização dos mesmos[N:Categoria|Categorias][G:a][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Unidades` (
  ...
  UNIQUE INDEX `Sigla_UNIQUE` (`Sigla` ASC))
ENGINE = InnoDB
COMMENT = 'Unidades de medidas aplicadas aos produtos[N:Unidade|Unidades][G:a][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Origens` (
  ...
  UNIQUE INDEX `Codigo_UNIQUE` (`Codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Origem da mercadoria[N:Origem|Origens][G:a][L:CadastroProdutos][K:MZ\\Invoice|MZ\\Invoice\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Operacoes` (
  ...
  UNIQUE INDEX `Codigo_UNIQUE` (`Codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Código Fiscal de Operações e Prestações (CFOP)[N:Operação|Operações][G:a][L:CadastroProdutos][K:MZ\\Invoice|MZ\\Invoice\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Tributacoes` (
  ...
  CONSTRAINT `FK_Tributacoes_Impostos_ImpostoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informação tributária dos produtos[N:Tributação|Tributações][G:a][L:CadastroProdutos][K:MZ\\Invoice|MZ\\Invoice\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Produtos` (
  ...
  CONSTRAINT `FK_Produtos_Tributacoes_TributacaoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informações sobre o produto, composição ou pacote[N:Produto|Produtos][G:o][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Servicos` (
  ...
  PRIMARY KEY (`ID`))
ENGINE = InnoDB
COMMENT = 'Taxas, eventos e serviço cobrado nos pedidos[N:Serviço|Serviços][G:o][L:CadastroServicos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Produtos_Pedidos` (
  ...
  CONSTRAINT `FK_ProdPed_Servicos_ServicoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Produtos, taxas e serviços do pedido, a alteração do estado permite o controle de produção[N:Item do pedido|Itens do pedido][G:o][L:Pagamento][K:MZ\\Sale|MZ\\Sale\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Cheques` (
  ...
  CONSTRAINT `FK_Cheques_Clientes_ClienteID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Cheques lançados como pagamentos[N:Cheque|Cheques][G:o][L:Pagamento][K:MZ\\Payment|MZ\\Payment\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Classificacoes` (
  ...
  CONSTRAINT `FK_Classificacoes_ClassificacaoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Classificação se contas, permite atribuir um grupo de contas[N:Classificação|Classificações][G:a][L:CadastroContas][K:MZ\\Account|MZ\\Account\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Contas` (
  ...
  CONSTRAINT `FK_Contas_Classificacoes_SubClassificacaoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Contas a pagar e ou receber[N:Conta|Contas][G:a][L:CadastroContas][K:MZ\\Account|MZ\\Account\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Creditos` (
  ...
  CONSTRAINT `FK_Creditos_Funcionarios_FuncionarioID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Créditos de clientes[N:Crédito|Créditos][G:o][L:CadastrarCreditos][K:MZ\\Account|MZ\\Account\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Pagamentos` (
  ...
  CONSTRAINT `FK_Pagamentos_Creditos_CreditoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Pagamentos de contas e pedidos[N:Pagamento|Pagamentos][G:o][L:Pagamento][K:MZ\\Payment|MZ\\Payment\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Auditoria` (
  ...
  CONSTRAINT `FK_Auditoria_Funcionarios_AutorizadorID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Registra todas as atividades importantes do sistema[N:Auditoria|Auditorias][G:a][L:RelatorioAuditoria][K:MZ\\System|MZ\\System\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Folhas_Cheques` (
  ...
  CONSTRAINT `FK_Folhas_Cheques_Cheques_ChequeID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Folhas de cheque de um pagamento[N:Folha de cheque|Folhas de cheques][G:a][L:Pagamento][K:MZ\\Payment|MZ\\Payment\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Composicoes` (
  ...
  CONSTRAINT `FK_Composicoes_Produtos_ProdutoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa as propriedades da composição de um produto composto[N:Composição|Composições][G:a][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Fornecedores` (
  ...
  CONSTRAINT `FK_Fornecedores_Clientes_EmpresaID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Fornecedores de produtos[N:Fornecedor|Fornecedores][G:o][L:CadastroFornecedores][K:MZ\\Stock|MZ\\Stock\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Estoque` (
  ...
  CONSTRAINT `FK_Estoque_Estoque_EntradaID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Estoque de produtos por setor[N:Estoque|Estoques][G:o][L:Estoque][K:MZ\\Stock|MZ\\Stock\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Grupos` (
  ...
  CONSTRAINT `FK_Grupos_Produtos_ProdutoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Grupos de pacotes, permite criar grupos como Tamanho, Sabores para formações de produtos[N:Grupo|Grupos][G:o][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Propriedades` (
  ...
  CONSTRAINT `FK_Propriedades_Grupos_GrupoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa tamanhos de pizzas e opções de peso do produto[N:Propriedade|Propriedades][G:a][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Pacotes` (
  ...
  CONSTRAINT `FK_Pacotes_Propriedades_PropriedadeID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Contém todos as opções para a formação do produto final[N:Pacote|Pacotes][G:o][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Dispositivos` (
  ...
  CONSTRAINT `FK_Dispositivos_Caixas_CaixaID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Computadores e tablets com opções de acesso[N:Dispositivo|Dispositivos][G:o][L:CadastroComputadores][K:MZ\\Device|MZ\\Device\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Impressoras` (
  ...
  CONSTRAINT `FK_Impressoras_Setores_SetorID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Impressora para impressão de serviços e contas[N:Impressora|Impressoras][G:a][L:CadastroImpressoras][K:MZ\\Device|MZ\\Device\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Promocoes` (
  ...
  CONSTRAINT `FK_Promocoes_Produtos_ProdutoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa se há descontos nos produtos em determinados dias da semana, o preço pode subir ou descer[N:Promoção|Promoções][G:a][L:CadastroProdutos][K:MZ\\Sale|MZ\\Sale\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Funcionalidades` (
  ...
  UNIQUE INDEX `Nome_UNIQUE` (`Nome` ASC))
ENGINE = InnoDB
COMMENT = 'Grupo de funcionalidades do sistema[N:Funcionalidade|Funcionalidades][G:a][L:AlterarConfiguracoes][K:MZ\\System|MZ\\System\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Permissoes` (
  ...
  CONSTRAINT `FK_Permissoes_Funcionalidades_FuncionalidadeID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa a listagem de todas as funções do sistema [N:Permissão|Permissões][G:a][L:AlterarConfiguracoes][K:MZ\\System|MZ\\System\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Acessos` (
  ...
  CONSTRAINT `FK_Acessos_Permissoes_PermissaoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Permite acesso à uma determinada funcionalidade da lista de permissões[N:Acesso|Acessos][G:o][L:AlterarConfiguracoes][K:MZ\\Employee|MZ\\Employee\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Catalogos` (
  ...
  CONSTRAINT `FK_Catalogos_Fornecedores_FornecedorID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa a lista de produtos disponíveis nos fornecedores[N:Catálogo de produtos|Catálogos de produtos][G:o][L:CadastroFornecedores][K:MZ\\Stock|MZ\\Stock\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Informacoes` (
  ...
  CONSTRAINT `FK_Informacoes_Unidades_UnidadeID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Permite cadastrar informações da tabela nutricional[N:Informação nutricional|Informações nutricionais][G:a][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Resumos` (
  ...
  CONSTRAINT `FK_Resumos_Cartoes_CartaoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Resumo de fechamento de caixa, informa o valor contado no fechamento do caixa para cada forma de pagamento[N:Resumo|Resumos][G:o][L:ConferirCaixa][K:MZ\\Session|MZ\\Session\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Formacoes` (
  ...
  CONSTRAINT `FK_Formacoes_Composicoes_ComposicaoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa qual foi a formação que gerou esse produto, assim como quais item foram retirados/adicionados da composição[N:Formação|Formações][G:a][L:Pagamento][K:MZ\\Sale|MZ\\Sale\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Listas` (
  ...
  CONSTRAINT `FK_Listas_Funcionario_EncarregadoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Lista de compras de produtos[N:Lista de compra|Listas de compras][G:a][L:ListaCompras][K:MZ\\Stock|MZ\\Stock\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Modulos` (
  ...
  UNIQUE INDEX `Nome_UNIQUE` (`Nome` ASC))
ENGINE = InnoDB
COMMENT = 'Módulos do sistema que podem ser desativados/ativados[N:Módulo|Módulos][G:o][L:AlterarConfiguracoes][K:MZ\\System|MZ\\System\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Compras` (
  ...
  CONSTRAINT `FK_Compras_Funcionarios_CompradorID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Compras realizadas em uma lista num determinado fornecedor[N:Compra|Compras][G:a][L:ListaCompras][K:MZ\\Stock|MZ\\Stock\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Requisitos` (
  ...
  CONSTRAINT `FK_Requisitos_Compras_CompraID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa os produtos da lista de compras[N:Produtos da lista|Produtos das listas][G:o][L:ListaCompras][K:MZ\\Stock|MZ\\Stock\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Enderecos` (
  ...
  CONSTRAINT `FK_Enderecos_Bairros_BairroID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Endereços de ruas e avenidas com informação de CEP[N:Endereço|Endereços][G:o][L:CadastroBairros][K:MZ\\Location|MZ\\Location\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Horarios` (
  ...
  PRIMARY KEY (`ID`))
ENGINE = InnoDB
COMMENT = 'Informa o horário de funcionamento do estabelecimento[N:Horário|Horários][G:o][L:AlterarHorario][K:MZ\\Company|MZ\\Company\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Valores_Nutricionais` (
  ...
  CONSTRAINT `FK_Valores_Nutricionais_Unidades_UnidadeID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa todos os valores nutricionais da tabela nutricional[N:Valor nutricional|Valores nutricionais][G:o][L:CadastroProdutos][K:MZ\\Product|MZ\\Product\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Transferencias` (
  ...
  CONSTRAINT `FK_Transf_ProdPed_ProdutoPedidoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa a transferência de uma mesa / comanda para outra, ou de um produto para outra mesa / comanda[N:Transferência|Transferências][G:a][L:TransferirProdutos][K:MZ\\Sale|MZ\\Sale\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Patrimonios` (
  ...
  CONSTRAINT `FK_Patrimonios_Clientes_EmpresaID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Informa detalhadamente um bem da empresa[N:Patrimônio|Patrimônios][G:o][L:CadastroPatrimonio][K:MZ\\Environment|MZ\\Environment\\][H:Model]';
...
ENGINE = InnoDB
COMMENT = 'Página WEB que contém informações de contato, termos e outras informações da empresa[N:Página|Páginas][G:a][L:AlterarPaginas][K:MZ\\System|MZ\\System\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Juncoes` (
  ...
  CONSTRAINT `FK_Juncoes_Pedidos_PedidoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Junções de mesas, informa quais mesas estão juntas ao pedido[N:Junção|Junções][G:a][L:MudarDeMesa][K:MZ\\Sale|MZ\\Sale\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Regimes` (
  ...
  UNIQUE INDEX `Codigo_UNIQUE` (`Codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Regimes tributários[N:Regime|Regimes][G:o][L:AlterarConfiguracoes][K:MZ\\Invoice|MZ\\Invoice\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Emitentes` (
  ...
  CONSTRAINT `FK_Emitentes_Regimes_RegimeID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Dados do emitente das notas fiscais[N:Emitente|Emitentes][G:o][L:AlterarConfiguracoes][K:MZ\\Invoice|MZ\\Invoice\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Notas` (
  ...
  CONSTRAINT `FK_Notas_Pedidos_PedidoID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Notas fiscais e inutilizações[N:Nota|Notas][G:a][L:RelatorioPedidos][K:MZ\\Invoice|MZ\\Invoice\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Eventos` (
  ...
  CONSTRAINT `FK_Eventos_Notas_NotaID`
    ...
    ON UPDATE RESTRICT)
ENGINE = InnoDB
COMMENT = 'Eventos de envio das notas[N:Evento|Eventos][G:o][L:RelatorioAuditoria][K:MZ\\Invoice|MZ\\Invoice\\][H:Model]';
...
ENGINE = InnoDB
COMMENT = 'Informa quais integrações estão disponíveis[N:Integração|Integrações][G:a][L:AlterarConfiguracoes][K:MZ\\System|MZ\\System\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `Mapeamentos` (
  ...
  `Tabela` VARCHAR(45) NOT NULL COMMENT 'Tabela que o registro',
  `De` INT NOT NULL,
  `Para` INT NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `Registros` (
  ...
  `Linha` INT NOT NULL,
  `Evento` ENUM('Inserido', 'Atualizado', 'Deletado') NOT NULL,
...
BEGIN
	...
	INSERT INTO `Mapeador` (`ServidorID`, `Tabela`, `De`, `Para`) VALUES
