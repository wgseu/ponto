...
CREATE TABLE IF NOT EXISTS `Requisitos` (
  ...
  `FornecedorID` INT NULL DEFAULT NULL COMMENT 'Fornecedor que deve ser consulado ou comprado os produtos, pode ser alterado no momento da compra[N:Fornecedor][G:o][S:S]',
...
ENGINE = InnoDB
COMMENT = 'Informa quais integrações estão disponíveis[N:Integração|Integrações][G:a][L:AlterarConfiguracoes][K:MZ\\System|MZ\\System\\][H:\\MZ\\Database\\Helper]';
