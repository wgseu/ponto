...
class ZSistema
{
    ...
    private static function validarCampos(&$sistema)
    {
        ...
        if (strlen($sistema['paisid']) == 0) {
            $sistema['paisid'] = null;
        } elseif (!is_numeric($sistema['paisid'])) {
        ...
        } elseif (!is_numeric($sistema['empresaid'])) {
        ...
        } elseif (!is_numeric($sistema['parceiroid'])) {
        ...
        } elseif (!is_numeric($sistema['computadores'])) {
    ...
    private static function BuildINI($ini)
    {
