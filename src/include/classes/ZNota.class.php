...
class ZNota {
	...
	private static function validarCampos(&$nota) {
		...
		if(strlen($nota['pedidoid']) == 0)
			$nota['pedidoid'] = null;
		else if(!is_numeric($nota['pedidoid']))
		...
		if(strlen($nota['contingencia']) == 0)
			$nota['contingencia'] = 'N';
		else if(!in_array($nota['contingencia'], array('Y', 'N')))
		...
		if(strlen($nota['tributos']) == 0)
			$nota['tributos'] = null;
		else if(!is_numeric($nota['tributos']))
		...
		else if(strtotime($nota['dataautorizacao']) !== false)
		...
		else if(strtotime($nota['dataemissao']) !== false)
		...
		else if(strtotime($nota['datalancamento']) !== false)
