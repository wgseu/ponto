...
class SessaoQuery extends Query
{
    ...
    {
        return Auth::check() && Auth::user()->can('sessao:view');
    }

    public function type(): Type
    {
        return GraphQL::paginate('Sessao');
    }
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Filter::apply(
            $args['filter'] ?? [],
            Sessao::with($fields->getRelations())->select($fields->getSelect())
        );
