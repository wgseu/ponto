...
\MZ\Session\ResumoApiController::addRoutes($collection);
\MZ\Session\SessaoApiController::addRoutes($collection);
\MZ\Sale\ComandaApiController::addRoutes($collection);
\MZ\Sale\FormacaoApiController::addRoutes($collection);
\MZ\Sale\JuncaoApiController::addRoutes($collection);
\MZ\Sale\TransferenciaApiController::addRoutes($collection);
...
\MZ\Invoice\EmitenteApiController::addRoutes($collection);
\MZ\Invoice\EventoApiController::addRoutes($collection);
\MZ\Invoice\ImpostoApiController::addRoutes($collection);
\MZ\Invoice\OperacaoApiController::addRoutes($collection);
\MZ\Invoice\OrigemApiController::addRoutes($collection);
\MZ\Invoice\RegimeApiController::addRoutes($collection);
\MZ\Invoice\TributacaoApiController::addRoutes($collection);
