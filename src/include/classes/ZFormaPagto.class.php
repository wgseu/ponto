...
class ZFormaPagto {
	...
	private static function validarCampos(&$forma_pagto) {
		...
		else if(!is_numeric($forma_pagto['minparcelas']))
			$erros['minparcelas'] = 'O mínimo de parcelas não foi informado';
		else if($forma_pagto['minparcelas'] < 0)
		...
		else if(!is_numeric($forma_pagto['maxparcelas']))
			$erros['maxparcelas'] = 'O máximo de parcelas não foi informado';
		else if($forma_pagto['maxparcelas'] < 0)
			$erros['maxparcelas'] = 'O máximo de parcelas não pode ser negativo';
		else if($forma_pagto['maxparcelas'] < $forma_pagto['minparcelas'])
		...
		else if(!is_numeric($forma_pagto['parcelassemjuros']))
			$erros['parcelassemjuros'] = 'As parcelas sem juros não foi informada';
		else if($forma_pagto['parcelassemjuros'] < 0)
			$erros['parcelassemjuros'] = 'As parcelas sem juros não podem ser negativas';
		else if($forma_pagto['parcelassemjuros'] < $forma_pagto['minparcelas'])
