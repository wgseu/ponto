...
class ZPagamento
{
    ...
    public static function getReceitas($sessao_id, $data_inicio = null, $data_fim = null)
    {
        ...
        if (!is_null($sessao_id)) {
            ...
            $query = $query->where(['mv.sessaoid' => $sessao_id]);
        }
    ...
    private static function initGetFaturamento(
        $sessao_id,
        $mes_inicio,
        $mes_fim,
        $dia_inicio,
    ...
    public static function getFaturamento(
        $sessao_id,
        $mes_inicio = null,
        $mes_fim = null,
        $dia_inicio = null,
    ...
    private static function validarCampos(&$pagamento)
    {
        ...
        } elseif (!is_numeric($pagamento['movimentacaoid'])) {
        ...
        } elseif (!is_numeric($pagamento['pedidoid'])) {
        ...
        } elseif (!is_numeric($pagamento['pagtocontaid'])) {
        ...
        } elseif (!is_numeric($pagamento['cartaoid'])) {
        ...
        } elseif (!is_numeric($pagamento['chequeid'])) {
        ...
        } elseif (!is_numeric($pagamento['contaid'])) {
        ...
        } elseif (!is_numeric($pagamento['creditoid'])) {
    ...
    private static function initSearchFaturamentos(
        $mes_inicio,
        $mes_fim,
        $dia_inicio,
        $dia_fim
    ...
    public static function getTodosFaturamentos(
        $mes_inicio = null,
        $mes_fim = null,
        $dia_inicio = null,
        $dia_fim = null,
    ...
    public static function getCountFaturamentos(
        $mes_inicio = null,
        $mes_fim = null,
        $dia_inicio = null,
        $dia_fim = null
