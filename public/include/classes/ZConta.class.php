...
class ZConta
{
    ...
    private static function validarCampos(&$conta)
    {
        ...
        } elseif (!is_numeric($conta['subclassificacaoid'])) {
        ...
        if (!is_numeric($conta['acrescimo'])) {
            ...
            } elseif ($conta['valor'] <= 0 && $conta['acrescimo'] > 0) {
        ...
        if (!is_numeric($conta['multa'])) {
            ...
            } elseif ($conta['valor'] <= 0 && $conta['multa'] > 0) {
