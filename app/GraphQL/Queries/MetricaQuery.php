...
class MetricaQuery extends Query
{
    ...
    {
        return true; // Auth::user()->can('metrica:view');
    }

    public function type(): Type
    {
        return GraphQL::paginate('Metrica');
    }

    public function args(): array
    {
        return [
            'filter' => ['name' => 'filter', 'type' => GraphQL::type('MetricaFilter')],
            'order' => ['name' => 'order', 'type' => GraphQL::type('MetricaOrder')],
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Metrica::with($fields->getRelations())
