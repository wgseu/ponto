...
class ZGrupo {
	...
	private static function validarCampos(&$grupo) {
		...
		if(strlen($grupo['funcao']) == 0)
			$grupo['funcao'] = null;
		else if(!in_array($grupo['funcao'], array('Minimo', 'Media', 'Maximo', 'Soma')))
