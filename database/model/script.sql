...
-- Wed 18 Sep 2019 11:43:14 AM -03
...
CREATE TABLE IF NOT EXISTS `setores` (
  ...
  CONSTRAINT `FK_setores_setor_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Setor de impressão e de estoque[N:Setor|Setores][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `mesas` (
  ...
  `nome` VARCHAR(50) NULL DEFAULT NULL COMMENT 'Nome da mesa[N:Nome][G:o][S]',
  ...
  CONSTRAINT `FK_mesas_setor_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Mesas para lançamento de pedidos[N:Mesa|Mesas][G:a][K:App\\Models|Models\\][H:Model]';
...
ENGINE = InnoDB
COMMENT = 'Sessão de trabalho do dia, permite que vários caixas sejam abertos utilizando uma mesma sessão[N:Sessão|Sessões][G:a][K:App\\Models|Models\\][H:Model]';
...
ENGINE = InnoDB
COMMENT = 'Bancos disponíveis no país[N:Banco|Bancos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `carteiras` (
  ...
  `data_desativada` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `FK_carteiras_carteira_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa uma conta bancária ou uma carteira financeira[N:Carteira|Carteiras][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `caixas` (
  ...
  CONSTRAINT `FK_caixas_carteira_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Caixas de movimentação financeira[N:Caixa|Caixas][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `formas` (
  ...
  CONSTRAINT `FK_formas_carteira_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Formas de pagamento disponíveis para pedido e contas[N:Forma de pagamento|Formas de pagamento][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `cartoes` (
  ...
  CONSTRAINT `FK_cartoes_forma_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Cartões utilizados na forma de pagamento em cartão[N:Cartão|Cartões][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `funcoes` (
  ...
  UNIQUE INDEX `descricao_UNIQUE` (`descricao` ASC))
ENGINE = InnoDB
COMMENT = 'Função ou atribuição de tarefas à um prestador[N:Função|Funções][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `twitter` VARCHAR(200) NULL DEFAULT NULL COMMENT 'URL para acessar a página do Twitter do cliente[N:Twitter][G:o]',
  `linkedin_url` VARCHAR(200) NULL DEFAULT NULL COMMENT 'URL para acessar a página do LinkedIn do cliente[N:LinkedIn][G:o]',
  ...
  `data_atualizacao` DATETIME NOT NULL COMMENT 'Data de atualização das informações do cliente[N:Data de atualização][G:a][D]',
  ...
  CONSTRAINT `FK_clientes_empresa_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações de cliente físico ou jurídico. Clientes, empresas, funcionários, fornecedores e parceiros são cadastrados aqui[N:Cliente|Clientes][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `prestadores` (
  ...
  CONSTRAINT `FK_prestadores_prestador_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Prestador de serviço que realiza alguma tarefa na empresa[N:Prestador|Prestadores][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `moedas` (
  ...
  UNIQUE INDEX `codigo_UNIQUE` (`codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Moedas financeiras de um país[N:Moeda|Moedas][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `paises` (
  ...
  CONSTRAINT `FK_paises_moeda_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações de um páis com sua moeda e língua nativa[N:País|Paises][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `estados` (
  ...
  CONSTRAINT `FK_estados_pais_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Estado federativo de um país[N:Estado|Estados][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `cidades` (
  ...
  CONSTRAINT `FK_cidades_estado_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Cidade de um estado, contém bairros[N:Cidade|Cidades][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `bairros` (
  ...
  CONSTRAINT `FK_bairros_cidade_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Bairro de uma cidade[N:Bairro|Bairros][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `zonas` (
  ...
  CONSTRAINT `FK_zonas_bairro_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Zonas de um bairro[N:Zona|Zonas][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `localizacoes` (
  ...
  CONSTRAINT `FK_localizacoes_zona_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Endereço detalhado de um cliente[N:Localização|Localizações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `comandas` (
  ...
  UNIQUE INDEX `numero_UNIQUE` (`numero` ASC))
ENGINE = InnoDB
COMMENT = 'Comanda individual, permite lançar pedidos em cartões de consumo[N:Comanda|Comandas][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `viagens` (
  ...
  CONSTRAINT `FK_viagens_responsavel_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Registro de viagem de uma entrega ou compra de insumos[N:Viagem|Viagens][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `integracoes` (
  ...
  `data_atualizacao` DATETIME NOT NULL COMMENT 'Data de atualização dos dados do módulo de integração[G:a][N:Data de atualização]',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `nome_UNIQUE` (`nome` ASC))
ENGINE = InnoDB
COMMENT = 'Informa quais integrações estão disponíveis[N:Integração|Integrações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `associacoes` (
  ...
  CONSTRAINT `FK_associacoes_entrega_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Lista de pedidos que não foram integrados ainda e devem ser associados ao sistema[N:Associação|Associações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  `tipo` ENUM('mesa', 'comanda', 'balcao', 'entrega') NOT NULL DEFAULT 'mesa' COMMENT 'Tipo de venda[N:Tipo][G:o][E:Mesa|Comanda|Balcão|Entrega][S:S][F:self::TIPO_MESA]',
  ...
  `data_entrega` DATETIME NULL DEFAULT NULL COMMENT 'Data e hora que o entregador saiu para entregar esse pedido[N:Data de entrega][G:a]',
  ...
  CONSTRAINT `FK_pedidos_associacao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações do pedido de venda[N:Pedido|Pedidos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `categorias` (
  ...
  `data_atualizacao` DATETIME NOT NULL COMMENT 'Data de atualização das informações da categoria[N:Data de atualização][G:a]',
  ...
  CONSTRAINT `FK_categorias_categoria_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa qual a categoria dos produtos e permite a rápida localização dos mesmos[N:Categoria|Categorias][G:a][L:CadastroProdutos][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `unidades` (
  ...
  UNIQUE INDEX `sigla_UNIQUE` (`sigla` ASC))
ENGINE = InnoDB
COMMENT = 'Unidades de medidas aplicadas aos produtos[N:Unidade|Unidades][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `origens` (
  ...
  UNIQUE INDEX `codigo_UNIQUE` (`codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Origem da mercadoria[N:Origem|Origens][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `operacoes` (
  ...
  UNIQUE INDEX `codigo_UNIQUE` (`codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Código Fiscal de Operações e Prestações (CFOP)[N:Operação|Operações][G:a][K:App\\Models|Models\\][H:Model]';
...
ENGINE = InnoDB
COMMENT = 'Impostos disponíveis para informar no produto[N:Imposto|Impostos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `tributacoes` (
  ...
  CONSTRAINT `FK_tributacoes_imposto_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informação tributária dos produtos[N:Tributação|Tributações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `produtos` (
  ...
  `data_atualizacao` DATETIME NOT NULL COMMENT 'Data de atualização das informações do produto[N:Data de atualização][G:a][D]',
  ...
  CONSTRAINT `FK_produtos_tributacao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações sobre o produto, composição ou pacote[N:Produto|Produtos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `servicos` (
  ...
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'Taxas, eventos e serviço cobrado nos pedidos[N:Serviço|Serviços][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `classificacoes` (
  ...
  CONSTRAINT `FK_classificacoes_classificacao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Classificação se contas, permite atribuir um grupo de contas[N:Classificação|Classificações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `contas` (
  ...
  CONSTRAINT `FK_contas_agrupamento_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Contas a pagar e ou receber[N:Conta|Contas][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `movimentacoes` (
  ...
  CONSTRAINT `FK_movimentacoes_fechador_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Movimentação do caixa, permite abrir diversos caixas na conta de operadores[N:Movimentação|Movimentações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `creditos` (
  ...
  CONSTRAINT `FK_creditos_cliente_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Créditos de clientes[N:Crédito|Créditos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `cheques` (
  ...
  CONSTRAINT `FK_cheques_banco_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Folha de cheque lançado como pagamento[N:Cheque|Cheques][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `pagamentos` (
  ...
  CONSTRAINT `FK_pagamentos_agrupamento_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Pagamentos de contas e pedidos[N:Pagamento|Pagamentos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `itens` (
  ...
  CONSTRAINT `FK_itens_pagamento_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Produtos, taxas e serviços do pedido, a alteração do estado permite o controle de produção[N:Item do pedido|Itens do pedido][G:o][U:Item|Itens][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `modulos` (
  ...
  UNIQUE INDEX `nome_UNIQUE` (`nome` ASC))
ENGINE = InnoDB
COMMENT = 'Módulos do sistema que podem ser desativados/ativados[N:Módulo|Módulos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `funcionalidades` (
  ...
  `modulo_id` INT NOT NULL COMMENT 'Módulo que essa funcionalidade pertence[G:o][N:Módulo]',
  ...
  CONSTRAINT `FK_funcionalidades_modulo_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Grupo de funcionalidades do sistema[N:Funcionalidade|Funcionalidades][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `permissoes` (
  ...
  CONSTRAINT `FK_permissoes_funcionalidade_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa a listagem de todas as funções do sistema [N:Permissão|Permissões][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `auditorias` (
  ...
  CONSTRAINT `FK_auditorias_permissao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Registra todas as atividades importantes do sistema[N:Auditoria|Auditorias][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `composicoes` (
  ...
  CONSTRAINT `FK_composicoes_produto_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa as propriedades da composição de um produto composto[N:Composição|Composições][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `fornecedores` (
  ...
  CONSTRAINT `FK_fornecedores_empresa_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Fornecedores de produtos[N:Fornecedor|Fornecedores][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `listas` (
  ...
  CONSTRAINT `FK_listas_viagem_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Lista de compras de produtos[N:Lista de compra|Listas de compras][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `compras` (
  ...
  CONSTRAINT `FK_compras_comprador_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Compras realizadas em uma lista num determinado fornecedor[N:Compra|Compras][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `requisitos` (
  ...
  CONSTRAINT `FK_requisitos_compra_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa os produtos da lista de compras[N:Produtos da lista|Produtos das listas][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `estoques` (
  ...
  `entrada_id` INT NULL DEFAULT NULL COMMENT 'Informa de qual entrada no estoque essa saída foi retirada, permite estoque FIFO[N:Entrada][G:a][S:S]',
  ...
  INDEX `FK_estoques_entrada_id_idx` (`entrada_id` ASC),
  ...
  CONSTRAINT `FK_estoques_requisito_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Estoque de produtos por setor[N:Estoque|Estoques][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `grupos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `produto_id_nome_UNIQUE` (`produto_id` ASC, `nome` ASC),
  CONSTRAINT `FK_grupos_produto_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Grupos de pacotes, permite criar grupos como Tamanho, Sabores para formações de produtos[N:Grupo|Grupos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `propriedades` (
  ...
  `data_atualizacao` DATETIME NOT NULL COMMENT 'Data de atualização dos dados ou da imagem da propriedade[N:Data de atualização][G:a]',
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `FK_propriedades_grupo_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa tamanhos de pizzas e opções de peso do produto[N:Propriedade|Propriedades][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `pacotes` (
  ...
  CONSTRAINT `FK_pacotes_propriedade_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Contém todos as opções para a formação do produto final[N:Pacote|Pacotes][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `dispositivos` (
  ...
  CONSTRAINT `FK_dispositivos_caixa_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Computadores e tablets com opções de acesso[N:Dispositivo|Dispositivos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `impressoras` (
  ...
  CONSTRAINT `FK_impressoras_setor_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Impressora para impressão de serviços e contas[N:Impressora|Impressoras][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `promocoes` (
  ...
  CONSTRAINT `FK_promocoes_promocao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa se há descontos nos produtos em determinados dias da semana, o preço pode subir ou descer e ser agendado para ser aplicado[N:Promoção|Promoções][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `acessos` (
  ...
  CONSTRAINT `FK_acessos_permissao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Permite acesso à uma determinada funcionalidade da lista de permissões[N:Acesso|Acessos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `catalogos` (
  ...
  `preco_venda` DECIMAL(19,4) NOT NULL DEFAULT 0 COMMENT 'Preço de venda do produto pelo fornecedor na última consulta[N:Preço de venda][G:o]',
  `quantidade_minima` DOUBLE NOT NULL DEFAULT 1 COMMENT 'Quantidade mínima que o fornecedor vende[N:Quantidade mínima][G:a]',
  ...
  CONSTRAINT `FK_catalogos_fornecedor_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa a lista de produtos disponíveis nos fornecedores[N:Catálogo de produtos|Catálogos de produtos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `sistemas` (
  ...
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'Classe que informa detalhes da empresa, parceiro e opções do sistema como a versão do banco de dados e a licença de uso[N:Sistema|Sistemas][G:o][L:AlterarConfiguracoes][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `resumos` (
  ...
  CONSTRAINT `FK_resumos_forma_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Resumo de fechamento de caixa, informa o valor contado no fechamento do caixa para cada forma de pagamento[N:Resumo|Resumos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `formacoes` (
  ...
  CONSTRAINT `FK_formacoes_composicao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa qual foi a formação que gerou esse produto, assim como quais item foram retirados/adicionados da composição[N:Formação|Formações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `enderecos` (
  ...
  CONSTRAINT `FK_enderecos_bairro_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Endereços de ruas e avenidas com informação de CEP[N:Endereço|Endereços][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `horarios` (
  ...
  CONSTRAINT `FK_horarios_funcao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa o horário de funcionamento do estabelecimento[N:Horário|Horários][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `patrimonios` (
  ...
  `data_atualizacao` DATETIME NOT NULL COMMENT 'Data de atualização das informações do bem[N:Data de atualização][G:a][D]',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `numero_UNIQUE` (`numero` ASC),
  ...
  CONSTRAINT `FK_patrimonios_empresa_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa detalhadamente um bem da empresa[N:Patrimônio|Patrimônios][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `juncoes` (
  ...
  CONSTRAINT `FK_juncoes_pedido_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Junções de mesas, informa quais mesas estão juntas ao pedido[N:Junção|Junções][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `regimes` (
  ...
  UNIQUE INDEX `codigo_UNIQUE` (`codigo` ASC))
ENGINE = InnoDB
COMMENT = 'Regimes tributários[N:Regime|Regimes][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `emitentes` (
  ...
  CONSTRAINT `FK_emitentes_regime_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Dados do emitente das notas fiscais[N:Emitente|Emitentes][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `notas` (
  ...
  CONSTRAINT `FK_notas_ultimo_evento_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Notas fiscais e inutilizações[N:Nota|Notas][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `eventos` (
  ...
  CONSTRAINT `FK_eventos_nota_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Eventos de envio das notas[N:Evento|Eventos][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `empresas` (
  ...
  CONSTRAINT `FK_empresas_pais_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informações da empresa[N:Empresa|Empresas][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `pontuacoes` (
  ...
  CONSTRAINT `FK_pontuacoes_promocao_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa os pontos ganhos e gastos por compras de produtos promocionais[N:Pontuação|Pontuações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `telefones` (
  ...
  CONSTRAINT `FK_telefones_pais_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Telefones dos clientes, apenas o telefone principal deve ser único por cliente[N:Telefone|Telefones][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `observacoes` (
  ...
  CONSTRAINT `FK_observacoes_produto_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Observações e instruções de preparo de produto[N:Observação|Observações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `cupons` (
  ...
  CONSTRAINT `FK_cupons_cliente_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Informa os cupons de descontos e seus usos[N:Cupom|Cupons][G:o][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `metricas` (
  ...
  UNIQUE INDEX `nome_UNIQUE` (`nome` ASC))
ENGINE = InnoDB
COMMENT = 'Métricas de avaliação do atendimento e outros serviços do estabelecimento[N:Métrica|Métricas][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `avaliacoes` (
  ...
  CONSTRAINT `FK_avaliacoes_produto_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Avaliação de atendimento e outros serviços do estabelecimento[N:Avaliação|Avaliações][G:a][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `cozinhas` (
  ...
  UNIQUE INDEX `nome_UNIQUE` (`nome` ASC))
ENGINE = InnoDB
COMMENT = 'Categoria de comida servida pelo estabelecimento[G:a][N:Cozinha|Cozinhas][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `cardapios` (
  ...
  `produto_id` INT NOT NULL COMMENT 'Produto que faz parte desse cardápio[G:o][N:Produto]',
  ...
  PRIMARY KEY (`id`),
  INDEX `produto_id_integracao_id_local_UNIQUE` (`produto_id` ASC, `integracao_id` ASC, `local` ASC),
  ...
  CONSTRAINT `FK_cardapios_produto_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Cardápios para cada integração ou local de venda[G:o][N:Cardápio|Cardápios][K:App\\Models|Models\\][H:Model]';
...
CREATE TABLE IF NOT EXISTS `contagens` (
  ...
  `data_atualizacao` DATETIME NOT NULL COMMENT 'Data em que a contagem foi atualizada[G:a][N:Data de atualização]',
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `FK_contagens_setor_id`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Guarda a soma do estoque de cada produto por setor[N:Contagem|Contagens][G:a][K:App\\Models|Models\\][H:Model]';
