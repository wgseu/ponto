...
class PedidoEstadoEnum extends EnumType
{
    protected $attributes = [
        ...
        'values' => [
            ...
            Pedido::ESTADO_FECHADO => Pedido::ESTADO_FECHADO,
            Pedido::ESTADO_CONCLUIDO => Pedido::ESTADO_CONCLUIDO,
            Pedido::ESTADO_CANCELADO => Pedido::ESTADO_CANCELADO,
        ],
    ];
}
