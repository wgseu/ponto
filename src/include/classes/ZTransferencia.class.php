...
class ZTransferencia
{
    ...
    private static function validarCampos(&$transferencia)
    {
        ...
        } elseif (!is_numeric($transferencia['mesaid'])) {
        ...
        } elseif (!is_numeric($transferencia['destinomesaid'])) {
        ...
        } elseif (!is_numeric($transferencia['comandaid'])) {
        ...
        } elseif (!is_numeric($transferencia['destinocomandaid'])) {
        ...
        } elseif (!is_numeric($transferencia['produtopedidoid'])) {
