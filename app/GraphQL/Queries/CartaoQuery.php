...
class CartaoQuery extends Query
{
    ...
    {
        return true; // Auth::user()->can('cartao:view');
    }
    ...
    {
        return [
            'filter' => ['name' => 'filter', 'type' => GraphQL::type('CartaoFilter')],
            'order' => ['name' => 'order', 'type' => GraphQL::type('CartaoOrder')],
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Cartao::with($fields->getRelations())
