...
CREATE TABLE IF NOT EXISTS `Carteiras` (
  ...
  INDEX `FK_Carteiras_CarteiraID_idx` (`CarteiraID` ASC),
...
CREATE TABLE IF NOT EXISTS `Clientes` (
  ...
  INDEX `FK_Clientes_EmpresaID_idx` (`EmpresaID` ASC),
...
CREATE TABLE IF NOT EXISTS `Prestadores` (
  ...
  INDEX `FK_Prestadores_PrestadorID_idx` (`PrestadorID` ASC),
...
CREATE TABLE IF NOT EXISTS `Localizacoes` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `FK_Localizacoes_Clientes_ClienteID_idx` (`ClienteID` ASC),
  UNIQUE INDEX `ClienteID_Apelido_UNIQUE` (`ClienteID` ASC, `Apelido` ASC),
  INDEX `FK_Localizacoes_Bairros_BairroID_idx` (`BairroID` ASC),
...
CREATE TABLE IF NOT EXISTS `Viagens` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `FK_Viagens_Prestadores_ResponsavelID_idx` (`ResponsavelID` ASC),
...
CREATE TABLE IF NOT EXISTS `Pedidos` (
  ...
  `DataEntrega` DATETIME NULL DEFAULT NULL COMMENT 'Data e hora que o entregador saiu para entregar esse pedido[N:Data de entrega][G:a]',
  ...
  INDEX `FK_Pedidos_PedidoID_idx` (`PedidoID` ASC),
...
CREATE TABLE IF NOT EXISTS `Categorias` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `Descricao_UNIQUE` (`Descricao` ASC),
  INDEX `FK_Categorias_CategoriaID_idx` (`CategoriaID` ASC),
...
CREATE TABLE IF NOT EXISTS `Contas` (
  ...
  INDEX `FK_Contas_ContaID_idx` (`ContaID` ASC),
  INDEX `FK_Contas_Carteiras_CarteiraID_idx` (`CarteiraID` ASC),
  INDEX `FK_Contas_AgrupamentoID_idx` (`AgrupamentoID` ASC),
...
CREATE TABLE IF NOT EXISTS `Cheques` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `IDX_Vencimento_Recolhido` (`Vencimento` ASC, `Recolhido` ASC),
...
CREATE TABLE IF NOT EXISTS `Pagamentos` (
  ...
  INDEX `FK_Pagamentos_Contas_CrediarioID_idx` (`CrediarioID` ASC),
  ...
  INDEX `FK_Pagamentos_PagamentoID_idx` (`PagamentoID` ASC),
  INDEX `FK_Pagamentos_Moedas_MoedaID_idx` (`MoedaID` ASC),
  INDEX `FK_Pagamentos_AgrupamentoID_idx` (`AgrupamentoID` ASC),
...
CREATE TABLE IF NOT EXISTS `Itens` (
  ...
  `PrestadorID` INT NULL DEFAULT NULL COMMENT 'Prestador que lançou esse item no pedido[N:Prestador][G:o][S:S]',
  ...
  PRIMARY KEY (`ID`),
  INDEX `IDX_DataLancamento` (`DataLancamento` DESC),
  INDEX `FK_Itens_ItemID_idx` (`ItemID` ASC),
...
CREATE TABLE IF NOT EXISTS `Auditoria` (
  ...
  INDEX `IDX_DataHora` (`DataHora` ASC),
...
CREATE TABLE IF NOT EXISTS `Estoque` (
  ...
  `PrestadorID` INT NULL DEFAULT NULL COMMENT 'Prestador que inseriu/retirou o produto do estoque[N:Prestador][G:o][S:S]',
  ...
  INDEX `FK_Estoque_EntradaID_idx` (`EntradaID` ASC),
...
CREATE TABLE IF NOT EXISTS `Pacotes` (
  ...
  INDEX `FK_Pacotes_AssociacaoID_idx` (`AssociacaoID` ASC),
...
CREATE TABLE IF NOT EXISTS `Dispositivos` (
  ...
  `Tipo` ENUM('Computador', 'Tablet', 'Navegador') NOT NULL DEFAULT 'Computador' COMMENT 'Tipo de dispositivo[N:Tipo][G:o][S:S]',
...
CREATE TABLE IF NOT EXISTS `Juncoes` (
  ...
  INDEX `IDX_MesaID_Estado` (`MesaID` ASC, `Estado` ASC),
...
CREATE TABLE IF NOT EXISTS `Empresas` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `FK_Empresas_Clientes_EmpresaID_idx` (`EmpresaID` ASC),
  INDEX `FK_Empresas_Clientes_ParceiroID_idx` (`ParceiroID` ASC),
  INDEX `FK_Empresas_Paises_PaisID_idx` (`PaisID` ASC),
...
CREATE TABLE IF NOT EXISTS `Cupons` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `FK_Cupons_CupomID_idx` (`CupomID` ASC),
