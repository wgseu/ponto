...
class HorarioQuery extends Query
{
    ...
    {
        return (($args['filter']['modo']['eq'] ?? null) == Horario::MODO_FUNCIONAMENTO) ||
            (Auth::check() && Auth::user()->can('horario:view'));
    }

    public function type(): Type
    {
        return GraphQL::paginate('Horario');
    }

    public function args(): array
    {
        return [
            'filter' => ['name' => 'filter', 'type' => GraphQL::type('HorarioFilter')],
            'order' => ['name' => 'order', 'type' => GraphQL::type('HorarioOrder')],
