...
class ObservacaoQuery extends Query
{
    ...
    {
        return true; // Auth::user()->can('observacao:view');
    }
    ...
    {
        return [
            'filter' => ['name' => 'filter', 'type' => GraphQL::type('ObservacaoFilter')],
            'order' => ['name' => 'order', 'type' => GraphQL::type('ObservacaoOrder')],
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $query = Observacao::with($fields->getRelations())
